        ...
        >
          ...
          <div className="text-center pt-4 pb-3 border-bottom">
            ...
            <h6 className="fw-bold mb-1" style={{ color: '#f4f6f9ff' }}>
              {JSON.parse(localStorage.getItem('user') || '{}')?.fullName || 'Teacher Name'}
            </h6>
            ...
            <div className="d-flex justify-content-center gap-3 px-3">
              <div className="text-center flex-fill">
                <div className="bg-light rounded p-2">
                  ...
                  <small className="fw-bold text-dark">Faculty</small>
                </div>
              </div>
              <div className="text-center flex-fill">
                <div className="bg-light rounded p-2">
                  <small className="text-muted d-block" style={{ fontSize: '10px' }}>Status</small>
                  <small className="fw-bold text-success">Active</small>
                </div>
              </div>
            </div>
          </div>
            ...
            <ul className="nav flex-column px-2">
              <Link to="/teacher" className='text-decoration-none'>
                <li className="nav-item mb-1">
                  <button 
                    className="nav-link w-100 text-start border-0 d-flex align-items-center py-3 px-3 rounded"
                    style={{ backgroundColor: 'transparent', color: '#f7f9fcff', transition: 'all 0.3s' }}
                    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#0d0d0dff'}
                    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="me-3">
              ...
              <Link to="/teacher" className='text-decoration-none'>
                <li className="nav-item mb-1">
                  <button 
                    className="nav-link w-100 text-start border-0 d-flex align-items-center py-3 px-3 rounded"
                    style={{ backgroundColor: 'transparent', color: '#fcfcfdff', transition: 'all 0.3s' }}
                    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#0d0d0dff'}
                    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="me-3">
                    ...
                    <span className="fw-medium">Courses/Exams</span>
                  </button>
                </li>
              </Link>
              ...
              <li className="nav-item mb-1">
                <button 
                  className="nav-link w-100 text-start border-0 d-flex align-items-center py-3 px-3 rounded text-white"
              ...
              <li className="nav-item mb-1">
                <button
                  className="nav-link w-100 text-start border-0 d-flex align-items-center py-3 px-3 rounded"
                  style={{ backgroundColor: 'transparent', color: '#dc3545', transition: 'all 0.3s', cursor: 'pointer' }}
                  onClick={() => {
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#dc3545" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="me-3">
